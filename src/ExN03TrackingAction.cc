...
void ExN03TrackingAction::PostUserTrackingAction(const G4Track *track)
{
  ...
  //	if((track->GetDefinition()->GetParticleType() == "kaon") ||(track->GetDefinition()->GetParticleType() == "nucleus") || (track->GetDefinition()->GetParticleName() == "proton") || (track->GetDefinition()->GetParticleName() == "neutron"))
