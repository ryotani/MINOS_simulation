//
// File generated by rootcint at Thu Sep 10 15:04:44 2015
...
atomic_TClass_ptr ExN03Datai::fgIsA(0);  // static to hold class pointer
...
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::ExN03Datai*)0x0)->GetClass();} }
   return fgIsA;
}
...
static void G__setup_memvarExN03Datai(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__ExN03DataiDictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
